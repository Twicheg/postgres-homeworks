...
SELECT MIN(unit_price),MAX(unit_price) FROM products WHERE discontinued = 0
...
SELECT MIN(unit_price),MAX(unit_price) FROM products WHERE discontinued = 0 AND units_in_stock >= 20
